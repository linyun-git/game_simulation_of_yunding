(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeroSquareComponent = /** @class */ (function () {
                ...
                HeroSquareComponent.prototype.statusEqualsWaiting = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TimerComponent = /** @class */ (function () {
                ...
                TimerComponent.prototype.TimeReady = function () {
                    this.maxTime = 3;
                };
                TimerComponent.prototype.TimeOut = function () {
                    this.textColor = 'red';
                    this.imgsrc = 'redTime';
                    this.maxTime = 10;
                    this.run(this.end);
                };
                TimerComponent.prototype.FightStart = function () {
                    this.textColor = 'white';
                    time = new Date();
                    this.maxTime = 30;
                    // this.run()
                };
                TimerComponent.prototype.run = function (fun) {
                    var _this = this;
                    var time = new Date();
                    var t = time.getTime() - this.thisTime;
                    var num = this.maxTime - parseInt((t / 1000).toString());
                ...
                TimerComponent.prototype.end = function () {
                    alert('end');
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/_@angular_core@8.2.14@@angular/core/fesm2015/core.js");
            /* harmony import */ var _components_hero_square_hero_square_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/hero-square/hero-square.component */ "./src/app/components/hero-square/hero-square.component.ts");
            var HasHeroStatusToStringPipe = /** @class */ (function () {
                function HasHeroStatusToStringPipe() {
                }
                HasHeroStatusToStringPipe.prototype.transform = function (status) {
                    switch (status) {
                ...
                return HasHeroStatusToStringPipe;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StatusEqualsWaitingPipe = /** @class */ (function () {
                function StatusEqualsWaitingPipe() {
                }
                StatusEqualsWaitingPipe.prototype.transform = function (status) {
                    if (status == _manager_frame_manager_frame_component__WEBPACK_IMPORTED_MODULE_2__["Status"].Waiting)
                        return true;
                    else
                        return false;
                };
                return StatusEqualsWaitingPipe;
            }());
